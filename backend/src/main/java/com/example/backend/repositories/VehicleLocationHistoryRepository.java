...
public interface VehicleLocationHistoryRepository extends JpaRepository<VehicleLocationHistory, VehicleLocationHistoryID> {
    ...
    List<VehicleLocationHistory> findByIdVehicleIDOrderByIdTimeStampDesc(Integer vehicleId);

    VehicleLocationHistory findFirstByIdVehicleIDOrderByIdTimeStampDesc(Integer vehicleId);
}
